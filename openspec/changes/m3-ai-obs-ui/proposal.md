...
- **`apps/api/src/ai-observability/dashboard/dto/ai-obs.dto.ts`** — Zod schemas + inferred types for the three response shapes. NO `@opentrattos/contracts` import per Wave 2.1+ hard rule; types stay inline at the controller boundary.
