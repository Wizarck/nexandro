...
canonicalOutputs:
  - docs/ux/DESIGN.md (project-level, 9-section format per ai-playbook ux-track.md §4)
  - docs/ux/{journey-id}.md (per-journey mocks, 5 journeys from PRD)
  - docs/ux/components.md (component candidate list — 13 named in PRD)
...
**Date:** 2026-04-27
**Status:** Draft — Step 1 init complete; awaiting brand-voice fork resolution
