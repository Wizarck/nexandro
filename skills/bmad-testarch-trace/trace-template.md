...
- `1.3-UNIT-005` - 1240 lines (exceeds 1000 line limit) - Split into multiple focused test files
...
2. **Split Large Test File** - Break `1.3-UNIT-005` (1240 lines) into multiple focused test files (<1000 lines each).
...
3. **Re-Run Gate After Fixes**
   ...
   - Re-run `/bmad-testarch-trace` workflow
